    ...
    <div class="slider-container">
        ...
        <div class="fixed-search-container">
            <form class="search-form" action="{{ route('home') }}" method="GET">
                <input type="text" class="search-input" placeholder="ابحث عن منتجك المفضل..." name="q" value="{{ request('q') }}">
                <button type="submit" class="search-icon" style="background: none; border: none; padding: 0; margin: 0;">
