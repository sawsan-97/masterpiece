                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('unit') is-invalid @enderror" id="unit" name="unit" required>
                                ...
                                <option value="كيلوغرام" {{ old('unit', $product->unit) == 'كيلوغرام' ? 'selected' : '' }}>كيلوغرام</option>
                                <option value="جرام" {{ old('unit', $product->unit) == 'جرام' ? 'selected' : '' }}>جرام</option>
                                <option value="لتر" {{ old('unit', $product->unit) == 'لتر' ? 'selected' : '' }}>لتر</option>
                                <option value="صندوق" {{ old('unit', $product->unit) == 'صندوق' ? 'selected' : '' }}>صندوق</option>
                            </select>
                            @error('unit')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
